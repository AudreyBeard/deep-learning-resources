...
In PyTorch, datasets and dataloaders are distinct things. A dataset (which you
will probably have to define for each problem) defines where your data comes
from, which fraction of that data is used in training and testing, how it
should be pulled into memory, how the data should be transformed, and how the
set can be indexed.
